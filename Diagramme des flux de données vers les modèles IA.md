```mermaid
flowchart LR
 subgraph subGraph0["Container Symfony"]
        A1[["Application Symfony 7<br>Module CRM existant"]]
        A2[["Module dédié IA"]]
  end
 subgraph subGraph1["Container PostgreSQL"]
 ...
 subgraph subGraph2["Container Python ML"]
 ...
 subgraph subGraph3["Container Redis"]
        D1[["Cache L1<br>Prédictions récentes<br>TTL: 1h"]]
        D2[["Cache L2<br>Simulations<br>TTL: 24h"]]
  end
 subgraph subGraph4["Infrastructure Docker Compose"]
        subGraph0
        subGraph1
        subGraph2
        subGraph3
